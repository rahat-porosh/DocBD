...
public class fetchhema extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchhema);
        intent=getIntent();
        st=intent.getStringExtra("valhema");
        textView=findViewById(R.id.hemadet);
        hemadoc a= new hemadoc(st);
        a.execute();
        fab = findViewById(R.id.fabhema);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchhema.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class hemadoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchhema.textView.setText(string1);
    }
}