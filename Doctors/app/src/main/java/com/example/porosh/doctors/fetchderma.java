...
public class fetchderma extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchderma);
        intent=getIntent();
        st=intent.getStringExtra("valderma");
        textView=findViewById(R.id.dermadet);
        dermadoc a=new dermadoc(st);
        a.execute();
        fab = findViewById(R.id.fabderma);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchderma.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class dermadoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Dermatology and Venereology");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchderma.textView.setText(string1);
    }
}