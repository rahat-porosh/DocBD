...
public class fetchdia extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchdia);
        intent=getIntent();
        st=intent.getStringExtra("valdia");
        textView=findViewById(R.id.diadet);
        diadoc a=new diadoc(st);
        a.execute();
        fab = findViewById(R.id.fabdia);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchdia.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class diadoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchdia.textView.setText(string1);
    }
}