...
public class fetchdent extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchdent);
        intent=getIntent();
        st=intent.getStringExtra("valdent");
        textView=findViewById(R.id.dentdet);
        dentdoc a=new dentdoc(st);
        a.execute();
        fab = findViewById(R.id.fabdent);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchdent.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class dentdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchdent.textView.setText(string1);
    }
}