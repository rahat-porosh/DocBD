...
public class fetchcosme extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchcosme);
        intent=getIntent();
        st=intent.getStringExtra("valcosme");
        textView=findViewById(R.id.cosmedet);
        cosmedoc a=new cosmedoc(st);
        a.execute();
        fab = findViewById(R.id.fabcosme);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchcosme.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class cosmedoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchcosme.textView.setText(string1);
    }
}