...
public class fetchvas extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchvas);
        intent=getIntent();
        st=getIntent().getStringExtra("valvas");
        textView=findViewById(R.id.vasdet);
        vasdoc a=new vasdoc(st);
        a.execute();
        fab = findViewById(R.id.fabvas);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchvas.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class vasdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchvas.textView.setText(string1);
    }
}