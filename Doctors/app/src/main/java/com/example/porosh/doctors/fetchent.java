...
public class fetchent extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchent);
        intent=getIntent();
        st=intent.getStringExtra("valent");
        textView=findViewById(R.id.entdet);
        entdoc a=new entdoc(st);
        a.execute();
        fab = findViewById(R.id.fabent);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchent.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class entdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchent.textView.setText(string1);
    }
}