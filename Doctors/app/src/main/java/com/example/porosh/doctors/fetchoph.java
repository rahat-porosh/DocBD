...
public class fetchoph extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchoph);
        intent=getIntent();
        st=getIntent().getStringExtra("valoph");
        textView=findViewById(R.id.ophdet);
        ophdoc a=new ophdoc(st);
        a.execute();
        fab = findViewById(R.id.faboph);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchoph.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class ophdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchoph.textView.setText(string1);
    }
}