...
public class fetchonc extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchonc);
        intent=getIntent();
        st=intent.getStringExtra("valonc");
        textView=findViewById(R.id.oncdet);
        oncdoc a= new oncdoc(st);
        a.execute();
        fab = findViewById(R.id.fabonc);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchonc.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class oncdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Oncologist(Cancer)-Medical/Surgeon");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchonc.textView.setText(string1);
    }
}