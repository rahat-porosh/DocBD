...
public class fetchplas extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchplas);
        intent=getIntent();
        st=getIntent().getStringExtra("valplas");
        textView=findViewById(R.id.plasdet);
        plasdoc a=new plasdoc(st);
        a.execute();
        fab = findViewById(R.id.fabplas);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchplas.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class plasdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchplas.textView.setText(string1);
    }
}