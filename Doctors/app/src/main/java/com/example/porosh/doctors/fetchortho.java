...
public class fetchortho extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchortho);
        intent=getIntent();
        st=intent.getStringExtra("valortho");
        textView=findViewById(R.id.orthodet);
        orthodoc a= new orthodoc(st);
        a.execute();
        fab = findViewById(R.id.fabortho);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchortho.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class orthodoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchortho.textView.setText(string1);
    }
}