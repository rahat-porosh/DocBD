...
public class fetchcardio extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchcardio);
        intent=getIntent();
        st=intent.getStringExtra("valcard");
        textView=findViewById(R.id.carddet);
        carddoc a=new carddoc(st);
        a.execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchcardio.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class carddoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchcardio.textView.setText(string1);
    }
}