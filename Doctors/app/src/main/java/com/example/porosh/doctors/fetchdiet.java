...
public class fetchdiet extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchdiet);
        intent=getIntent();
        st=intent.getStringExtra("valdiet");
        textView=findViewById(R.id.dietdet);
        dietdoc a=new dietdoc(st);
        a.execute();
        fab = findViewById(R.id.fabdiet);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchdiet.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class dietdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchdiet.textView.setText(string1);
    }
}