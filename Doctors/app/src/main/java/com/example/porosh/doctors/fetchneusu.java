...
public class fetchneusu extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchneusu);
        intent=getIntent();
        st=intent.getStringExtra("valneusu");
        textView=findViewById(R.id.medneusu);
        neusurdoc a= new neusurdoc(st);
        a.execute();
        fab = findViewById(R.id.fabneusu);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchneusu.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class neusurdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchneusu.textView.setText(string1);
    }
}