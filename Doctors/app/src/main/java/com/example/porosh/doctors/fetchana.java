...
public class fetchana extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fecthana);
        intent = getIntent();
        st = getIntent().getStringExtra("valana");
        textView = findViewById(R.id.anadet);
        anadoc a = new anadoc(st);
        a.execute();
        fab = findViewById(R.id.fabana);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchana.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
    ...
    class anadoc extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                JSONArray jsonArray = jsonObject.getJSONArray("Anaesthesiologist");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            fetchana.textView.setText(string1);
        }
    }
}