...
public class fetchmat extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchmat);
        intent=getIntent();
        st=intent.getStringExtra("valmat");
        textView=findViewById(R.id.matdet);
        matdoc a= new matdoc(st);
        a.execute();
        fab = findViewById(R.id.fabmat);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchmat.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class matdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Maternity and Child Specialist");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchmat.textView.setText(string1);
    }
}