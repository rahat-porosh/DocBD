...
public class fetchneume extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchneume);
        intent=getIntent();
        st=intent.getStringExtra("valneu");
        textView=findViewById(R.id.neumeddet);
        neumeddoc a= new neumeddoc(st);
        a.execute();
        fab = findViewById(R.id.fabneume);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchneume.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class neumeddoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchneume.textView.setText(string1);
    }
}