...
public class fecthsono extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fecthsono);
        intent=getIntent();
        st=intent.getStringExtra("valsono");
        textView=findViewById(R.id.sonodet);
        sonodoc a= new sonodoc(st);
        a.execute();
        fab = findViewById(R.id.fabsono);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fecthsono.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class sonodoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Medical Sonography");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fecthsono.textView.setText(string1);
    }
}