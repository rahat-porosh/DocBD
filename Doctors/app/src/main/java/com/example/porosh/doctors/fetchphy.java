...
public class fetchphy extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchphy);
        intent=getIntent();
        st=getIntent().getStringExtra("valphy");
        textView=findViewById(R.id.phydet);
        phydoc a=new phydoc(st);
        a.execute();
        fab = findViewById(R.id.fabphy);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchphy.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class phydoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchphy.textView.setText(string1);
    }
}