...
public class fetchgas extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchgas);
        intent=getIntent();
        st=intent.getStringExtra("valgas");
        textView=findViewById(R.id.gasdet);
        gasdoc a= new gasdoc(st);
        a.execute();
        fab = findViewById(R.id.fabgas);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchgas.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class gasdoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Gastro Phy/Hepatologist");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchgas.textView.setText(string1);
    }
}