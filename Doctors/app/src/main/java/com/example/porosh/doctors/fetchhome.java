...
public class fetchhome extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchhome);
        intent=getIntent();
        st=intent.getStringExtra("valhome");
        textView=findViewById(R.id.homedet);
        homedoc a= new homedoc(st);
        a.execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchhome.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class homedoc extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("Homeopathy Doctor");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchhome.textView.setText(string1);
    }
}