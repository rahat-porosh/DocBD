...
public class fetchmed extends AppCompatActivity {
    Intent intent;
    String st;
    static String st1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetchmed);
        intent=getIntent();
        st=getIntent().getStringExtra("valmed");
        textView=findViewById(R.id.meddet);
        meddoc a=new meddoc(st);
        a.execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (st1.equals("")) {
                    Toast.makeText(fetchmed.this, "No phone number", Toast.LENGTH_SHORT).show();
                } else {
...
class meddoc extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        fetchmed.textView.setText(string1);
    }
}